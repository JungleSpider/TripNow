...
#back {
	content: "";
        background-image: url("/tripnow/images/main.jpg");
...
    }
	...
	#back {
		background-image: url("/tripnow/images/main.png");
		background-repeat: no-repeat;
		background-size: 1060px;
		background-position: center center;
		height: 400px;
					...
					<form method="POST" action="/tripnow/home/list.do">
						<div id="b_search">
							<div class="inlinetext">
								<div id="maphide">
									<i class="fa-solid fa-location-dot"></i> <input type="text"
										id="loca" value="서울특별시 강남/역삼/삼성/논현" name="loca"> <i
                           ...
                           <li class="mapsido">
							...
							<div>
								<i class="fa-solid fa-calendar-check"></i> <input type="text"
									id="dates" name="dates"> <i class="fa-solid fa-sort-down"></i>
									<input type="hidden" id="hiddendate" name="hiddendate">
							</div>
							<div>
								<i class="fa-solid fa-children"></i> <input type="number"
									class="count" name="count" value="2" min="1" max="5">명
							</div>
